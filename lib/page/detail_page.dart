        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${widget.coin.priceChangePercentage24h ?? 0.0} %', // Default to 0.0 if null
                style: TextStyle(
                  color: (widget.coin.priceChangePercentage24h ?? 0.0) < 0
                      ? Colors.red
                      : Colors.green,
                ),
              ),
                ...
                children: [
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.blue, // You can set the button's background color if needed
                    ),
                    child: Text(
                      '1D',
                      style: TextStyle(
